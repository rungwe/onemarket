...
namespace WorldWebMall.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        private ICollection<string> ValidRoles = new List<string>() { "customer" , "company" , "merchant"};
        ...
        public async Task<IHttpActionResult> GetExternalLogin(string provider, string error = null)
        {
            ...
            if (hasRegistered)
            {
                ...
                AuthenticationProperties properties = ApplicationOAuthProvider.CreateProperties(user.UserName, "customer");
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            if (model.type.ToLower() == "customer")
            {
